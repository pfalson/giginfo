...
$field_language = isset($field['time_picker_options']['language']) ? $field['time_picker_options']['language'] : \App::getLocale();
?>
...
<div @include('crud::inc.field_wrapper_attributes') >
    ...
    <div class="input-group bootstrap-timepicker timepicker">
        <input
                ...
                data-provide="timepicker" data-minute-step="30"
...
@if ($crud->checkIfFieldIsFirstOfItsType($field, $fields))
    ...
    @if ($field_language !== 'en')
        <script charset="UTF-8"
                src="{{ asset('vendor/adminlte/plugins/timepicker/locales/bootstrap-timepicker.'.$field_language.'.js') }}"></script>
        <script charset="UTF-8"
    ...
    <script>
        ...
        jQuery(document).ready(function ($) {
            $('[data-bs-timepicker]').each(function () {
                ...
                $fake.timepicker('setTime', $field[0].defaultValue);
