    ...
    $.widget("tardate.AddToCal",
        {
            options: {
                ...
                /*
                 * calendars is a collection of all the supported calendars and the method for formatting
                ...
                calendars : [
                    ...
                    {value: 3, label:"Add to Live Calendar",
                        enabled : function(addtocal) { return true; },
                        formatlink : function(eventDetails) {
                    ...
                    {value: 4, label:"Add to Yahoo! Calendar",
                        enabled : function(addtocal) { return true; },
                        formatlink : function(eventDetails) {
