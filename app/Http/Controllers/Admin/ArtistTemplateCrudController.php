...
use App\Http\Requests\ArtistTemplateRequest as StoreRequest;
use App\Http\Requests\ArtistTemplateRequest as UpdateRequest;

class ArtistTemplateCrudController extends CrudController
{
	...
	public function setUp()
	{
		...
		|--------------------------------------------------------------------------
		*/
		$this->crud->setModel("App\Models\ArtistTemplate");
		$this->crud->setRoute("admin/artist_template");
		...
		if ($hasArtists)
		{
			...
			$this->crud->addField(
				[
					...
					'label' => 'Name',
					'type'  => 'text',
					'hint'  => 'Something to identify this template'
				]
			);
			...
			$this->crud->addField(
				[
					...
					'hint'       => 'PHP/HTML/Laravel-blade syntax'
				]
			);
		}
		else
